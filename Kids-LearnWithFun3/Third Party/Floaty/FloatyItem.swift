...
open class FloatyItem: UIView {
    ...
    /**
     Title label color.
     */
    @objc open var titleColor: UIColor = UIColor.red {
        didSet {
    ...
    /**
     Circle Shadow color.
     */
    @objc open var circleShadowColor: UIColor = UIColor.clear
    
    /**
     Title Shadow color.
     */
    @objc open var titleShadowColor: UIColor = UIColor.clear
    ...
    @objc open var imageSize: CGSize = CGSize(width:47 , height: 47) {
        didSet {
